...
- `GET /global-indices/kline?symbol=HSI|N225|KOSPI&period=1d|5d`
...
- fill `hk/jp/kr` global index groups from the proxy
- fetch global index charts through the proxy when available
